...
class EpistemicState:
    ...
    def requires_fallback(self) -> bool:
        ...
        return self.knowledge_type == KnowledgeType.UNKNOWN or (
    ...
    @classmethod
    def from_eurocode_calculation(
        cls, value: Any, norm: str, metadata: Optional[Dict] = None
    ) -> "EpistemicState":
    ...
    def from_monte_carlo(
        cls, value: Any, confidence: float, n_simulations: int, metadata: Optional[Dict] = None
    ) -> "EpistemicState":
...
def create_verified_state(
    value: Any, source: str, metadata: Optional[Dict] = None
) -> EpistemicState:
...
def create_estimated_state(
    value: Any, confidence: float, source: str, metadata: Optional[Dict] = None
) -> EpistemicState:
