...
def get_access_token():
    ...
    access_token = settings.get("access_token") or settings.get("oauth", {}).get(
        "credentials", {}
    ).get("access_token")
...
def create_event(
    summary, start_time, end_time=None, description=None, location=None, calendar_id="primary"
):
    """
    ...
    event_body = {
        "summary": summary,
        "start": {"dateTime": start_time.isoformat(), "timeZone": "Europe/Vienna"},
        "end": {"dateTime": end_time.isoformat(), "timeZone": "Europe/Vienna"},
    }
...
def get_calendar_status():
    ...
    try:
        ...
        return {
            ...
            "capabilities": ["list_calendars", "list_events", "create_events", "create_reminders"],
        }
