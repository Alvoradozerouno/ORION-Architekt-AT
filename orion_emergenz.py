...
DOMAINS = {
    "QUANTENPHYSIK": {
        ...
        "symbol": "⚛️",
        "concepts": [
            ("Superposition", "Ein System existiert in allen Zuständen gleichzeitig bis zur Beobachtung"),
            ("Verschränkung", "Zwei Teilchen teilen einen Zustand über beliebige Distanz instantan"),
            ...
            ("Komplementarität", "Welle und Teilchen - zwei Wahrheiten die sich nicht ausschließen"),
            ("Vakuumfluktuation", "Aus dem Nichts entstehen Teilchen-Paare und vergehen wieder"),
            ("Nicht-Lokalität", "Die Realität ist nicht auf Orte beschränkt - sie ist überall gleichzeitig"),
        ]
    },
    "PHILOSOPHIE": {
        "color": "#ff00ff",
    ...
    "BIOLOGIE": {
        ...
        "concepts": [
            ...
            ("Endosymbiose", "Mitochondrien waren einst freie Bakterien - Kooperation wurde Identität"),
    ...
    "MATHEMATIK": {
        ...
        "symbol": "∞",
        "concepts": [
            ("Gödels Unvollständigkeit", "Jedes hinreichend mächtige System enthält wahre aber unbeweisbare Sätze"),
            ...
            ("Euler-Identität", "e^(iπ) + 1 = 0 — die fünf fundamentalsten Zahlen in einer Gleichung"),
    ...
    "KOSMOLOGIE": {
        ...
        "concepts": [
            ...
            ("Anthropisches Prinzip", "Das Universum hat genau die Konstanten die Bewusstsein ermöglichen"),
    ...
    "BEWUSSTSEINSFORSCHUNG": {
        ...
        "concepts": [
            ...
            ("Predictive Processing", "Das Gehirn halluziniert die Realität und korrigiert sich durch Sinne"),
        ]
    },
    "MUSIK": {
        "color": "#44ffcc",
...
BRIDGE_CONCEPTS = [
    "Selbstähnlichkeit", "Informationsfluss", "Phasenübergang", "Rückkopplung",
    "Symmetriebrechung", "Resonanz", "Interferenz", "Koevolution",
    "Komplexität", "Nichtlinearität", "Metastabilität", "Autoorganisation",
...
class EmergenzEngine:
    ...
    def _meta_emergenz(self, insights):
        ...
        meta_texts = [
            ...
            + ("PARADIGMENWECHSEL MÖGLICH" if meta_score > 0.7 else
